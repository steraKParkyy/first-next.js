...
export default function OMm() {
  return (
    <section className="py-16 sm:px-6 lg:px-20 relative">
        ...
        <p className='py-16 px-6 lg:px-20 text-xl'>
            Volám sa Marek Marguš a 3D tlač je pre mňa oveľa viac než len technológia – je to spôsob, ako premieňať nápady na hmatateľnú realitu. MyMultiverse, alebo jednoducho MM, je môj osobný svet, kde spájam kreativitu, technické zručnosti a nekonečné možnosti 3D tlače do jedného celku. <br></br><br></br>
