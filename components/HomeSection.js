...
export default function HomeSection() {
  ...
  return (
    <section
      style={{ transform: `translateY(${translateY}px)` }}
      className="relative inset-0 flex flex-col items-center justify-start text-center pt-20 z-0 px-4 sm:px-6 lg:px-20 h-[90vh] sm:h-screen overflow-hidden">
      ...
      >
        <source src="/assets/video/pathspace.mp4" type="video/mp4" />
