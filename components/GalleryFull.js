...
//     thumb: `/assets/imghomepagegallery/IMG${i + 1}.jpg`,
//     original: `/assets/imgoriginal/IMG${i + 1}.jpg`
//   }))
...
//   return (
//     <section className="h-screen py-16 sm:px-6 lg:px-20 justify-items-center relative">
//       <h2 className="text-3xl font-bold text-black text-shadow-black text-center mb-14 mt-4">
//         Galéria
//       </h2>
